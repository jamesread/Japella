...
```yaml title="config.x.yaml"
configversion: 2

x:
  client_id: "abcdefghijklmnopqrstuvwxyz01234567" #notsecret
  client_secret: "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwx" #notsecret
```
