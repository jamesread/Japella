...
require (
	...
	buf.build/gen/go/japella/japella/connectrpc/go v1.18.1-20250309213621-b12e7e3f90a6.1 // indirect
	...
	go.mau.fi/whatsmeow v0.0.0-20250326122532-6680c9a6e9a7 // indirect
